...
class MultipleRegression:
    def __init__(self, data):
        ...
        self.data = self.data.set_index(["Company Name", "year"])
        # self.dependent_variable = dependent_variable
        # self.independent_variables = independent_variables

    def model_regression(self, dependent_variable, independent_variables):
        panel_data_model = PanelOLS(
            dependent_variable, independent_variables, entity_effects=True
        )
...
if __name__ == "__main__":
    ...
    for values in dependent_variable:
        panel_data_model = PanelOLS(
            panel_data[values], panel_data[independent_variables], entity_effects=True
        )
